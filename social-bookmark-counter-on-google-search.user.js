...
text-decoration: none;\
  ...
  var USER_AGENT =
    'Mozilla/5.0 (compatible; Social bookmark Counter/0.9.1; +https://github.com/ikeikeikeike/social-bookmark-counter-on-google-search)';
    ...
    GM_xmlhttpRequest({
      ...
      onload: function(data) {
        try {
          ...
          var receiveCount = function(o) {
              return o;
            },
            IN = {
              Tags: {
                Share: {
                  handleCount: function(o) {
                    return o;
                  },
                },
              },
  ...
  function renderHtml(link, total, url, className) {
    ...
    try {
      ...
      var ss = link.parentNode.parentNode.parentNode.getElementsByClassName(
        'r',
      )[0];
      if (s) {
        ...
        tonode.parentNode.insertBefore(
          span,
          tonode.parentNode.firstChild.nextSibling,
        );
      } else if (ss) {
  ...
  function diggCountView(link) {
    var url =
      ...
      link.href +
      '&type=javascript&callback=crossdomain_res';
 ...
 */
  ...
  function main(doc) {
    ...
    var params = [];
    var n,
      l = doc.getElementsByClassName('r');
